...
Este proyecto desarrolla un sistema que **scrapea productos desde 3 supermercados chilenos** y permite que un **agente LLM (Claude)**, apoyado por un sistema **RAG**, genere carritos de compra optimizados basados en _prompts escritos en lenguaje natural_.

Ejemplo de prompt:

> _"Quiero hacer un asado con 5 amigos y un presupuesto de alrededor de 50.000."_
