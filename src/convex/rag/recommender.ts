import { EmbeddingProvider, LLMProvider, Product, RecommendationRequest, RecommendationResult } from "./types"
...
export class RAGRecommender {
  ...
  private formatProductForEmbedding(product: Product): string {
